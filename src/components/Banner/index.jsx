              ...
              <Col lg={6} className="p-4">
                ...
                <Row>
                  <Col className="container-pessoas d-flex flex-direction-row gap-1 mt-3">
                    <img src={perfil1} alt="Imagem perfil rede social" />
                    <img src={perfil2} alt="Imagem perfil rede social" />
                    <img src={perfil3} alt="Imagem perfil rede social" />
                    <img src={perfil4} alt="Imagem perfil rede social" />
                    <img src={perfil5} alt="Imagem perfil rede social" />
                  </Col>
