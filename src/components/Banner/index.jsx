              ...
              <Col lg={6} className="p-4">
                ...
                <Row>
                  <Col className="container-pessoas d-flex flex-direction-row gap-1 mt-3">
                    <img src={perfil1} alt="Foto de perfil rede social" />
                    <img src={perfil2} alt="Foto de perfil rede social" />
                    <img src={perfil3} alt="Foto de perfil rede social" />
                    <img src={perfil4} alt="Foto de perfil rede social" />
                    <img src={perfil5} alt="Foto de perfil rede social" />
                  </Col>
                  <Col className="container-avaliacao d-flex flex-direction-row justify-content-between aling-items-center flex-wrap">
                    <img src={estrelaVerde} alt="Imagem ilustrativa estrela verde" />
                    ...
                    <div className="d-flex flex-direction-row align-items-center gap-1">
                      <div className="background-estrela">
                        <img src={estrelaBranca} alt="Estrela ilustrativa na cor branca" />
                      </div>
                      <div className="background-estrela">
                        <img src={estrelaBranca} alt="Estrela ilustrativa na cor branca" />
                      </div>
